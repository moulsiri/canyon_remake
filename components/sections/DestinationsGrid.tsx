...
const DestinationsGrid = () => {
  ...
  return (
    <section ref={containerRef} className="relative z-[20] w-full min-h-screen bg-[#F4F4F1] dark:bg-stone-950 py-16 md:py-24">
      {/* Restored Header Block */}
      <div ref={contentRef} className="flex flex-col items-center w-full px-6 md:px-12 max-w-7xl mx-auto text-center mb-20 md:mb-32">
        <p ref={eyebrowRef} className="text-xs md:text-sm tracking-[0.25em] font-medium uppercase mb-12 text-stone-800 dark:text-stone-100 drop-shadow-md">
        PLACES TO BEGIN
        </p>
        <h2
          ref={titleRef}
        ...
        <p ref={descriptionRef} className="text-stone-800 dark:text-stone-200 text-sm md:text-base font-medium leading-relaxed tracking-wide max-w-3xl">
