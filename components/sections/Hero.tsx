    ...
    <section className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-20 flex flex-col items-center text-center px-4 max-w-[90%] md:max-w-4xl pt-[15vh]">
        ...
        <FadeIn delay={0.9} yOffset={25}>
          <h1
            className="text-5xl sm:text-6xl md:text-8xl lg:text-[80px] leading-[0.9] text-white mb-6"
        ...
        >
          <button
            ...
            className="bg-[#b35930] hover:bg-[#942721] transition-all duration-300 cursor-pointer text-white px-10 md:px-14 py-4 md:py-5 text-xs md:text-sm tracking-[0.15em] uppercase font-semibold shadow-2xl hover:shadow-none translate-y-0 hover:translate-y-[2px]"
          >
            Begin Your Journey
          </button>
        </FadeIn>
