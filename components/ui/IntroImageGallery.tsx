...
const IntroImageGallery = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.from("#gallery_main_bg", {
        ...
        .from(["#gallery_image1", "#gallery_image2", "#gallery_image3"], {
          opacity: 0,
          y: 30,
          duration: 0.8,
          stagger: 0.15,
  ...
  return (
    <div className="mt-12 md:mt-60 w-full">
      ...
      <div ref={galleryRef} className="hidden lg:block">
        <div className="w-full aspect-[16/9] md:aspect-[21/9] relative shadow-2xl flex flex-col-reverse">
          <div
            id="gallery_gradient"
            className="absolute bg-gradient-to-r from-[var(--background)] to-transparent w-1/2 h-full top-0 left-0 z-10 pointer-events-none"
          ></div>
          ...
          <div
            id="gallery_image1"
            className="absolute -translate-x-1/2 -translate-y-1/2 top-[0%] left-[50%] w-[40%] z-20 shadow-2xl  overflow-hidden"
          >
            <Image
          ...
          <div
            id="gallery_image2"
            className="absolute top-[10%] left-[-10%] w-[30%] z-20 shadow-2xl  overflow-hidden"
          >
            <Image
          ...
          <div
            id="gallery_image3"
            className="absolute bottom-[-30%] left-[12%] w-[40%] z-20 shadow-2xl  overflow-hidden"
          >
            <Image
          ...
          <div className="absolute right-0 bottom-[-40%] w-[45%]  flex flex-col items-end text-right z-30">
